...
namespace Pandaros.API.Entities
{
    ...
    public class PlayerState
    {
        ...
        private static localization.LocalizationHelper _localizationHelper = new localization.LocalizationHelper(GameInitializer.NAMESPACE, "System");
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.OnUpdate, GameInitializer.NAMESPACE + ".Entities.PlayerState.OnUpdate")]
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.OnPlayerDisconnected, GameInitializer.NAMESPACE + ".Entities.PlayerState.OnPlayerDisconnected")]
        public static void OnPlayerDisconnected(Players.Player p)
        {
            _playerStates[p].Connected = false;
        }

        [ModLoader.ModCallback(ModLoader.EModCallbackType.OnPlayerConnectedLate, GameInitializer.NAMESPACE + ".Entities.PlayerState.OnPlayerConnectedSuperLate")]
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.OnLoadingPlayer, GameInitializer.NAMESPACE + ".Entities.PlayerState.OnLoadingPlayer")]
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.OnSavingPlayer, GameInitializer.NAMESPACE + ".Entities.PlayerState.OnSavingPlayer")]
        public static void OnSavingPlayer(JSONNode n, Players.Player p)
        {
            if (_playerStates.ContainsKey(p))
            {
                ...
                n.SetAs(GameInitializer.NAMESPACE + ".PlayerState", node);
            }
        }
    }
}