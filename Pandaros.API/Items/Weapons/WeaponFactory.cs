...
namespace Pandaros.API.Items.Weapons
{
    ...
    public static class WeaponFactory
    {
        ...
        private static localization.LocalizationHelper _localizationHelper = new localization.LocalizationHelper(GameInitializer.NAMESPACE, "Weapon");

        [ModLoader.ModCallback(ModLoader.EModCallbackType.OnUpdate, GameInitializer.NAMESPACE + ".Items.Weapons.WeaponFactory.CheckIfMonstersNearby")]
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.OnPlayerClicked, GameInitializer.NAMESPACE + ".Items.Weapons.WeaponFactory.WeaponAttack")]
